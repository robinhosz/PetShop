...
/**
 * Servlet implementation class cadastrarProdutorController
 */
@WebServlet("/cadastrarProdutorController")
public class cadastrarProdutorController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public cadastrarProdutorController() {
        super();
